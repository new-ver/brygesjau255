	...
	<header>
		...
		<div class="party-details">
			...
			<div class="festival-info">
				<p class="description">
					Once again I have the privilege to invite you to the annual summer party. Most of you know
					the drill by now: Bring what you want to eat/drink, let me know if you're crashing, and
					don't hesitate to invite people.
				</p>
				<div class="dress-code">
					<p><b>New of the year</b></p>
					<strong>Dress Code:</strong> Festival flora fashion, comfortable dancing feet, and an open
					heart 🌺🍃
				</div>
			</div>
		</div>
	...
	<section class="rsvp-form">
		...
		<form on:submit|preventDefault={submitRSVP}>
			...
			<div class="form-group">
				...
				<div class="radio-group">
					<label class="radio-option attending">
						<input type="radio" bind:group={formData.attending} value={true} />
						<span class="radio-custom"></span>
						Yes, I'm ready! 🚀
					</label>
					<label class="radio-option not-attending">
						<input type="radio" bind:group={formData.attending} value={false} />
						<span class="radio-custom"></span>
			...
			{#if submitMessage}
				<p
					class="message"
					class:success={submitMessage.includes('success')}
